-- Full schema baseline: documents all 17 tables including the new `experience` and `education` tables.
...
-- For fresh databases: apply this migration or run push from a clean state.
