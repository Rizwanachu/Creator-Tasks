...
- **`api/index.js`** at the root: pre-built CJS bundle of the Express app (generated by `build:serverless` during Vercel build, gitignored). Vercel detects it as a serverless function and serves it.
