...
export function OnboardingPage() {
  ...
  const isAutoGeneratedHandle = (u: string | null | undefined): boolean =>
    !!u && /^creator-[a-z0-9]+$/.test(u);
  const rawExistingUsername = existingProfile?.username ?? null;
  const existingUsername = isAutoGeneratedHandle(rawExistingUsername) ? null : rawExistingUsername;
